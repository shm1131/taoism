...
import io.github.shm1131.taoism.client.data.ClientCultivationCache;
...
public class NetworkHandlerClient {
    ...
    public static void handle(SyncJingLiDataPayload payload, IPayloadContext context) {
        ClientJingLiCache.update(payload.data());
    }
}
